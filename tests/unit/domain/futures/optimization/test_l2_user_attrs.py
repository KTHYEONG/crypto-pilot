...
EXPECTED_KEYS: set[str] = {
    "l2_objective_value", "cagr_hybrid", "cagr_baseline",
    "growth_lcb_hybrid", "growth_lcb_baseline",
    "sharpe_hac_hybrid", "sharpe_hac_baseline",
    "psr_hybrid", "mdd_hybrid", "cvar_95_hybrid",
    "fold_pass_ratio", "break_even_pass_pct",
    "average_gross_exposure", "cap_saturation_ratio",
    "total_cost_bps", "sortino_hybrid", "risk_utilization",
    "recent_fold_sharpe", "recent_fold_cagr",
    "latest_to_median_cagr", "deploy_leverage",
    "deployment_objective_bonus", "worst_fold_sharpe",
    "trade_count", "recent_fold_passed", "deploy_binding",
    "l2_constraint_values", "l2_optuna_constraint_values",
    "l2_promotion_constraint_values", "l2_promotion_passed",
    "l2_promotion_blocker", "l2_block_log_growth_signature",
}
