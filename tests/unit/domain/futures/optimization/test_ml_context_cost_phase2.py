...
def test_attach_execution_cost_dynamic_path_overrides_static_floor() -> None:
    ...
    backup = {
        ...
        "FUTURES_COST_LATENCY_BUFFER_BPS": OPT_FUTURES_CONFIG.get(
            "FUTURES_COST_LATENCY_BUFFER_BPS", 0.5
        ),
        "FUTURES_COST_ORDER_NOTIONAL_USDT": OPT_FUTURES_CONFIG.get(
            "FUTURES_COST_ORDER_NOTIONAL_USDT", 0.0
        ),
        "FUTURES_COST_FUNDING_EVENT_BUFFER_BPS": OPT_FUTURES_CONFIG.get(
