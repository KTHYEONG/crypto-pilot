...
class TestClassifyEdgeFailureRows:
    ...
    def test_empty_dataframe_returns_columns(self) -> None:
        ...
        assert list(result.columns) == [
            "recipe_id", "mean_gross_bps", "mean_cost_bps", "cost_drag_ratio",
            "nw_tstat", "turnover_per_year", "net_lcb_bps", "gross_lcb_bps",
            "failure_axis", "failure_axes", "failure_diagnostic",
        ]
