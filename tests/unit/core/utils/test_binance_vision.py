...
def test_fetch_daily_metrics_encodes_unicode_symbol_once(monkeypatch: pytest.MonkeyPatch) -> None:
    downloader = BinanceVisionDownloader()
    ...
    downloader.fetch_daily_metrics("币安人生USDT", pd.Timestamp("2026-07-01"))
