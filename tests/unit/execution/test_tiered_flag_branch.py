...
def test_use_cs_rank_engine_false_skips_tiered() -> None:
    ...
    with patch("src.execution.opt_main_futures.OPT_FUTURES_CONFIG", {"USE_CS_RANK_ENGINE": False}):
        with patch("src.domain.futures.strategy.tiered_workflow.run_tiered_pipeline") as mock_tp:
...
def test_use_cs_rank_engine_flag_readable() -> None:
    """OPT_FUTURES_CONFIG에서 USE_CS_RANK_ENGINE 키 읽기 가능하고 기본값=False."""
