...
- **Boundary Mocking:** Mock external network boundaries, exchange WebSocket/REST APIs, hardware I/O, and non-deterministic clock/system interfaces. Never mock internal business logic or transform tests into meaningless mock-chains.
