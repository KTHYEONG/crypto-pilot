...
from config.settings import FUTURES_STRATEGY_DB, SPOT_STRATEGY_DB


def display_study_results(db_path: str, title: str) -> None:
    print(f"\n{'=' * 80}")
    print(f"{title}")
    ...
    try:
        ...
        for summary in study_summaries:
            ...
            try:
                ...
                print(f"\nStudy Name: {study_name}")
                print(f"  Error loading best trial: {exc}")
    except Exception as exc:
