...
if TYPE_CHECKING:
    from src.domain.futures.signals.dataset import CandidateFeatureSchema
    from src.domain.futures.signals.ensemble import RegimeConditionalEnsemble
...
class Layer1FoldReadiness:
    ...
    def __init__(
        ...
        *,
        ...
        compat_ic_series = tuple(probe_series_bps)
        compat_probe_series = tuple(probe_series_bps)
        compat_match_count = int(matched_event_count)
        compat_unique_count = int(unique_decision_count) if unique_decision_count else compat_match_count
        compat_pred_count = int(prediction_unique_count) if prediction_unique_count else compat_match_count
