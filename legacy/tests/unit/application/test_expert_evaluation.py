...
from src.application.research.technical.evaluation import run_technical_expert_evaluation
...
def test_rejected_candidate_is_not_registered(
    ...
    monkeypatch.setattr(
        "src.application.research.technical.evaluation._load_technical_market_data",
        lambda symbol, start, end: (frame, funding),
    )
    monkeypatch.setattr(
        "src.application.research.technical.evaluation.technical_data_hashes",
...
def test_technical_expert_equity_exhaustion_returns_pending(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "src.application.research.technical.evaluation.compute_code_hash",
        lambda *args, **kwargs: "c" * 64,
    )
    monkeypatch.setattr(
        "src.application.research.technical.evaluation._run_evaluation",
