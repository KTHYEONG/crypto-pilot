...
from src.core.settings import SPOT_BACKTEST_END_DATE, SPOT_INITIAL_BALANCE
...
def screen_broad_universe(
    *,
    ...
    """
    from src.domain.futures.optimization.opt_config import SPOT_SCREENER_CONFIG, get_quarterly_window
...
def screen_symbol_refinement(
    ...
    *,
    ...
    """
    from src.domain.futures.optimization.opt_config import SPOT_ANCHOR_SYMBOLS, SPOT_SCREENER_CONFIG
...
def screen_universe() -> None:
    ...
    from src.domain.futures.optimization.opt_config import SPOT_ANCHOR_SYMBOLS, SPOT_SCREENER_CONFIG, get_quarterly_window
