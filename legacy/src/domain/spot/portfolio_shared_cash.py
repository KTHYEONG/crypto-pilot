...
from src.domain.futures.optimization.opt_config import SLIPPAGE_GAMMA_BASE, SLIPPAGE_REFERENCE_ADV_KRW
from src.core.settings import SPOT_INITIAL_BALANCE, SPOT_SLIPPAGE_RATE, UPBIT_SPOT_TAKER_FEE_RATE
...
def _warn_if_numba_shared_cash_smoke_fails() -> None:
    ...
    try:
        from src.domain.spot.portfolio_shared_cash_numba import use_numba_shared_cash
