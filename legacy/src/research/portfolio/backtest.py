...
from src.research.baseline.backtest import BacktestResult, _align_funding_rates, calculate_position_size
...
def _check_contract() -> None:
    ...
    from src.research.contracts import PortfolioSpec  # noqa: PLC0415
