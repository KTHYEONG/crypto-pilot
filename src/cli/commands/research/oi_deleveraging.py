...
from src.application.research.oi_deleveraging import evaluation as evaluation_module
...
def add_oi_deleveraging_commands(run_sub: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    """Attach the ``research run oi-deleveraging`` subcommand."""
