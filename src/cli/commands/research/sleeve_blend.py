...
from src.application.research.sleeve_blend import evaluation as evaluation_module
...
def add_sleeve_blend_commands(run_sub: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    """Attach the ``research run sleeve-blend`` subcommand."""
