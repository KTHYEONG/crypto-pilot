...
from src.domain.futures.strategy.legacy.alpha_evaluation import (
    derive_signed_rank_signal,
    diagnose_alpha_ic_decomposition,
    effective_breadth_corr,
)
from src.domain.futures.strategy.legacy.cache import build_manifest_hash
...
from src.domain.futures.strategy.legacy.dataset import (
    build_long_matrix,
...
from src.domain.futures.strategy.legacy.features import build_feature_panel
from src.domain.futures.strategy.integrity import (
    select_features,
    verify_data_integrity,
    verify_feature_integrity,
)
from src.domain.futures.strategy.legacy.labels import build_label_panel
...
from src.domain.futures.strategy.legacy.ranker import RankerFitResult, fit_ranker, predict_rank_score
