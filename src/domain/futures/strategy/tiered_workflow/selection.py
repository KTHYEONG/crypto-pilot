    ...
    *,
    ...
    for candidate, candidate_evaluation, candidate_config in evaluated_triples:
        ...
        gate = evaluate_layer2_gate(
            ...
            config=candidate_config,
            cagr_baseline=float(candidate_evaluation.cagr_baseline),
            recency_holdout_cagr=candidate_evaluation.recency_holdout_cagr,
            recency_holdout_applicable=bool(candidate_evaluation.recency_holdout_applicable),
            window_bottleneck_covered=bool(candidate_evaluation.window_bottleneck_covered),
            window_bottleneck_detail=str(candidate_evaluation.window_bottleneck_detail),
