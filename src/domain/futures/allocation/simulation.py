...
from src.domain.futures.allocation.deployment import trend_efficiency_gross_mult
from src.domain.futures.allocation.entry import apply_entry_cooldown
from src.domain.futures.allocation.regime_debug import (
...
if TYPE_CHECKING:
    from src.domain.futures.allocation.contracts import SymbolRealizedStat
...
def _run_awf_simulation(
    *,
    ...
    from src.domain.futures.allocation.metrics import _cagr, _mdd
    ...
    from src.domain.futures.allocation.regime_policy import (
