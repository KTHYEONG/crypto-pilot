...
from src.domain.futures.allocation.deployment import (
    apply_deployment,
)
from src.domain.futures.allocation.diagnostics import (
...
from src.domain.futures.allocation.simulation import (
    _run_awf_simulation,
    _stack_oos_signals,
)
...
def build_l1_prequential_evidence_snapshots(
    *,
    ...
    if not evidence_folds:
        ...
        import src.domain.futures.signals.workflow as cw
...
def _prefit_layer1_from_globals(
    ...
    import src.domain.futures.signals.workflow as _cw
...
def run_l1_nested_swf(
    *,
    ...
    import src.domain.futures.signals.workflow as cw
    from src.domain.futures.signals.dataset import (
    ...
    *,
    ...
    if l1_result_override is not None:
        ...
        if _can_prime_feature_cache(labeled_events):
            ...
            from src.domain.futures.signals.dataset import prime_aligned_feature_cache
