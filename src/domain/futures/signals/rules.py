...
from src.domain.futures.signals.contracts import CandidateSignalPanel, SignalExitPolicy
...
def _default_exit_policy(panel: CandidateSignalPanel) -> SignalExitPolicy:
