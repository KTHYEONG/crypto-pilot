...
from src.core.indicators.indicators_advanced import IndicatorEngine


_FUTURES_CACHE_MODE = os.getenv("FUTURES_INDICATOR_CACHE_MODE", os.getenv("INDICATOR_CACHE_MODE", "signature"))
_ENGINE = IndicatorEngine(cache_mode=_FUTURES_CACHE_MODE)
