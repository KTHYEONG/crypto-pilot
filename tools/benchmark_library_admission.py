...
import numpy as np
from src.quant.technical_experts.admission import (
    _assemble_panel,
    _materialize_definitions,
    _run_symbol_tasks,
    run_technical_library_admission,
)
from src.quant.expert_portfolio.admission_types import (
    LibraryAdmissionConfig,
    TechnicalLibraryAdmissionRequest,
)
from src.quant.expert_portfolio.models import ContextualRouterSpec
from src.quant.provenance.code_manifest import TECHNICAL_CODE_UNITS, compute_code_hash

from src.common.settings import HARDWARE_MAX_WORKERS, effective_worker_count
