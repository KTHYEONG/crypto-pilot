...
- **Gate Contract**:
   ...
   - Promotion (3-stage): Sortino ≥ 1.5 → Sharpe ≥ 0.7 → Calmar ≥ 0.5 + CAGR/MAR/PSR/growth_lcb/uplift + cost_drag + worst_fold_cagr(`l2_min_worst_fold_cagr=-0.05`) + block_delta(`l2_min_positive_block_delta_ratio=0.45`).
